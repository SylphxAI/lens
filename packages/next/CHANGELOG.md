...
- Updated `@sylphx/lens-react` to 2.6.2
...
- Updated `@sylphx/lens-react` to 2.5.2
...
- Updated `@sylphx/lens-react` to 2.3.4
...
- Updated `@sylphx/lens-react` to 2.2.0
...
- Updated `@sylphx/lens-react` to 2.1.7

## 2.1.6 (2025-12-05)

### 📦 Dependencies

- Updated `@sylphx/lens-react` to 2.1.6

## 2.1.5 (2025-12-05)

### 📦 Dependencies

- Updated `@sylphx/lens-react` to 2.1.5
...
- **deps:** update Changesets to 1.3.9 ([73af518](https://github.com/SylphxAI/Lens/commit/73af5183ff6cfd75cf340a197a7fbd3e6235920e))
